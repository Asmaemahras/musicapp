...
function Music() {
  return (
    <div className="music flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#020917] rounded-xl mt-5">

    <div className="upperPart flex items-center justify-between">
    
      <div className="profile flex">
        <img
          src={require("../img/logomus.png")}
          alt=""
          className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full"
        />
        <div className="detailsf flex flex-col ml-4">
          <span className="text-[1rem] text-gray-500">Tristam Bone Dry</span>
          ...
          <div className="pauseButton flex items-center relative">
            ...
            <svg width="40" height="40" viewBox="0 0 40 40">
              <defs>
                ...
                >
                  <stop offset="0" stop-color="#f2068c" /> 
